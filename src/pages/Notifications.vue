      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="alert alert-info">
            <button type="button" aria-hidden="true" class="close">×</button>
            <span>
              <b> Info - </b> Estas son las notificaciones que llevan mas de 1 dias sin responder 
              ".alert-info"</span
            >
          </div>
          <div class="alert alert-success">
            <button type="button" aria-hidden="true" class="close">×</button>
            <span>
              <b> Success - </b> Estas son las notificaciones que llevan mas de 2 dias sin responder 
              ".alert-success"</span
            >
          </div>
          <div class="alert alert-warning">
            <button type="button" aria-hidden="true" class="close">×</button>
            <span>
              <b> Warning - </b> Estas son las notificaciones que llevan mas de 4 dias sin responder 
              ".alert-warning"</span
            >
          </div>
          <div class="alert alert-danger">
            <button type="button" aria-hidden="true" class="close">×</button>
            <span>
              <b> Danger - </b> Estas son las notificaciones que llevan mas de 5 dias sin responder 
             </span
            >
          </div>
        </div>
